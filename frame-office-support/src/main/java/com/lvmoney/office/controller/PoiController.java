...
*/
     ...
     */
    @GetMapping("/tChange")
    public void tChange(WordSourceVo wSourceVo) {
        wordService.officeChange(wSourceVo);
    }


    @GetMapping("/test")
    public void test(WordSourceVo wSourceVo) {
        wordService.getTemplateParams(wSourceVo);
    }


    @GetMapping("/generateWord2")
    public ResultData<ExcelHeadVo> generateWord2(String data) {
        //图片路径，请注意你是linux还是windows
        String wordPath = "F:\\sclt\\file\\";
        String modelName = "test.docx";
        String outputName = "hanyunxi.docx";
...
//              //网路图片
        ...
        ExcelHeadVo eHeadVo = new ExcelHeadVo();
