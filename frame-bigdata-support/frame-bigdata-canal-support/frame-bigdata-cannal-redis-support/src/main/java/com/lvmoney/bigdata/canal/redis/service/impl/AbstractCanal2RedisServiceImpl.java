 ...
 */
public abstract class AbstractCanal2RedisServiceImpl implements Canal2RedisService {
    @Autowired
    BaseRedisService baseRedisService;

    private static final String SQL_DORP = "DROP";

    private static final String SQL_DORP_DATABASE = "DROP DATABASE";
    ...
    public void deleteDbRorRedis(DbMsgVo dbMsgVo, CanalEntry.RowChange rowChange) {
        ...
        if (sql.contains(SQL_DORP) && sql.contains(SQL_DORP_DATABASE) && sql.startsWith(SQL_DORP_DATABASE)) {
