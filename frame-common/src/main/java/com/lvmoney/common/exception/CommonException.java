...
public interface CommonException {
    ...
    enum Proxy implements ExceptionType {
         ...
         * 重复提交支持与否
         */
        REPEATSUBMIT_SUPPORT_ERROR(PROXYERR + 116, "frame.repeactsubmit.support value is 'true' or 'false'"),

        /**
         * 重复提交支持与否
         */
        REPEATSUBMIT_REQUEST_ERROR(PROXYERR + 117, "short time resubmission error"),
