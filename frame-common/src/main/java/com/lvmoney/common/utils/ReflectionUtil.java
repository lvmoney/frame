...
public class ReflectionUtil {
     ...
     */
    static {
        DateLocaleConverter _dc = new DateLocaleConverter();
        // dc.setPatterns(new String[] { "yyyy-MM-dd", "yyyy-MM-dd HH:mm:ss" });
        ConvertUtils.register(_dc, Date.class);
    }
    ...
    public static void invokeSetterMethod(Object target, String propertyName,
        ...
        Class<?> _type = propertyType != null ? propertyType : value.getClass();
        String _setterMethodName = (propertyName.startsWith("set") ? "" : "set")
                + StringUtil.Capitalize(propertyName);
        invokeMethod(target, _setterMethodName, new Class[]{_type},
                new Object[]{value});
    }
    ...
    public static Object getFieldValue(final Object object,
        ...
        Field _field = getDeclaredField(object, fieldName);
    ...
    public static Object invokeMethod(final Object object,
        ...
        Method _method = getDeclaredMethod(object, methodName, parameterTypes);
        if (_method == null) {
        ...
        try {
            return _method.invoke(object, parameters);
        } catch (Exception e) {
    ...
    protected static Field getDeclaredField(final Object object,
        ...
        for (Class<?> _superClass = object.getClass(); _superClass != Object.class; _superClass = _superClass
                .getSuperclass()) {
            try {
                return _superClass.getDeclaredField(fieldName);
    ...
    public static Class getSuperClassGenricType(final Class clazz,
                                                final int index) {
        Type _genType = clazz.getGenericSuperclass();

        if (!(_genType instanceof ParameterizedType)) {
            logger.warn(clazz.getSimpleName()
                    + "'s superclass not ParameterizedType");
            return Object.class;
        }

        Type[] _params = ((ParameterizedType) _genType)
        ...
        if (!(_params[index] instanceof Class)) {
            logger.warn(clazz.getSimpleName()
    ...
    public static List convertElementPropertyToList(
        ...
        try {
            for (Object _obj : collection) {
                _list.add(PropertyUtils.getProperty(_obj, propertyName));
            }
        } catch (Exception e) {
            throw convertReflectionExceptionToUnchecked(e);
        }
    ...
    public static String convertElementPropertyToString(
        ...
        List _list = convertElementPropertyToList(collection, propertyName);
        return StringUtil.Join(_list, separator);
    }
    ...
    public static void copyPorperties(Object dest, Object source,
        ...
        for (String por : porperties) {
            Object _srcObj = invokeGetterMethod(source, por);
            logger.debug("属性名[" + por + "]属性值[" + _srcObj + "]");
            if (_srcObj != null) {
                try {
                    BeanUtils.setProperty(dest, por, _srcObj);
    ...
    public static void copyPorperties(Object dest, Object source)
        ...
        Class _srcCla = source.getClass();
        Field[] _fsF = _srcCla.getDeclaredFields();
